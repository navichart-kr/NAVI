 ...
 * 피보나치 심화 레슨 — 6단계
 *
 * 교육용 구간: 2026-03-30 저점 $164.27 → 2026-04-27 고점 $216.83
 * (+31.4% 상승 후 2026-05-04 $194.74에서 38.2% 레벨 반등 확인)
 *
...
export const fibonacciSteps: TutorialStep[] = [
  ...
  // ── STEP 5  퀴즈 ──────────────────────────────────────────
  {
    ...
    judgment: {
      ...
      hints: [
        '고점 $217 - 저점 $164 = 범위 $53',
        '38.2% 레벨은 $217 - $53×0.382 ≈ $197',
        '실제 저점 $194.74는 $197 부근이에요',
      ],
      choices: [
        {
          value:    '236',
          icon:     '→',
          label:    '23.6% (약 $204)',
          feedback: '23.6%는 $204 부근이에요. 가격이 $204까지만 내려오고 반등했다면 추세가 극도로 강한 거예요. 이 구간에서는 더 깊게 조정이 왔어요.',
        },
        {
          value:    '382',
          icon:     '✓',
          label:    '38.2% (약 $197)',
          feedback: '맞아요! +31% 상승 후 38.2% 레벨($197) 부근에서 반등이 시작됐어요. 강한 상승 추세에서는 38.2%에서 매수세가 먼저 유입되는 경우가 많아요. 이후 가격은 $235까지 재상승했어요.',
        },
        {
          value:    '50',
          icon:     '→',
          label:    '50% (약 $191)',
          feedback: '50% 레벨은 $191 부근이에요. 실제 저점 $194.74보다 아래에 있어요. 반등은 그 전에 이미 시작됐어요.',
        },
        {
          value:    '618',
          icon:     '→',
