...
export const tutorialSteps: TutorialStep[] = [
  ...
  // ══════════════════════════════════════════════════════════
  {
    ...
    mobileTips: [
      '화면 하단 [작도] 버튼을 탭해요',
      '추세선을 선택하면 메뉴가 닫혀요',
      '차트에서 저점 두 개를 클릭하면 선이 완성돼요',
      '잘못 그렸다면 [작도] → 전체 삭제로 초기화할 수 있어요',
    ],
    mission:        '추세선을 한 번 직접 그어보세요 (안 그려도 다음으로 넘어갈 수 있어요)',
    mobileMission:  '하단 [작도] 메뉴를 열고 추세선을 그어보세요 (건너뛰어도 돼요)',
    actionRequired: 'free',
  },
  ...
  // ══════════════════════════════════════════════════════════
  {
    ...
    mobileMission:  '아래 [MA 켜기] 버튼을 탭하거나, 하단 [분석] 메뉴에서 MA를 켜보세요',
  ...
  // ══════════════════════════════════════════════════════════
  {
    ...
    mobileMission:           '아래 [RSI 켜기] 버튼을 탭하거나, 하단 [분석] 메뉴에서 RSI를 켜보세요',
    actionRequired:          'indicator-toggle',
    indicatorKey:            'rsi',
  ...
  // ══════════════════════════════════════════════════════════
  {
    ...
    mobileMission:           '아래 [MACD 켜기] 버튼을 탭하거나, 하단 [분석] 메뉴에서 MACD를 켜보세요',
    actionRequired:          'indicator-toggle',
    indicatorKey:            'macd',
  ...
  // ══════════════════════════════════════════════════════════
  {
    ...
    mobileMission:           '아래 [BB 켜기] 버튼을 탭하거나, 하단 [분석] 메뉴에서 BB를 켜보세요',
    actionRequired:          'indicator-toggle',
  ...
  // ══════════════════════════════════════════════════════════
  {
    ...
    mobileTips: [
      '화면 하단 [작도] 버튼을 탭해요',
      '피보나치를 선택하면 메뉴가 닫혀요',
      '차트에서 고점과 저점을 차례로 클릭해요',
      '38.2%, 50%, 61.8%가 주요 지지/저항선이에요',
    ],
    mission:        '피보나치를 한 번 그어보세요 (안 그려도 다음으로 넘어갈 수 있어요)',
    mobileMission:  '하단 [작도] 메뉴를 열고 피보나치를 그어보세요 (건너뛰어도 돼요)',
    actionRequired: 'free',
  },
  ...
  // ══════════════════════════════════════════════════════════
  {
    ...
    mobileTargetSelector: '#mobile-indicator-links',
    position:             'top',
    title:                '더 깊이 배우고 싶다면',
